...
from simondice.claseJugador import Jugador
from simondice.claseGestorJugadores import GestorJugadores
...
class Aplicacion():
    ...
    # FUNCION NUEVA --- Añadir este método para manejar los comandos de voz
